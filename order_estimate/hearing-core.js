...
(function () {
  ...
  var DEFAULT_KB = {
    ...
    sizeAdvice: 'サイズ選びの目安（手帳メーカー・専門店ガイドの市場傾向 2026-07調査）: バイブルは業界の標準サイズでリフィルの種類が最も豊富。仕事・プライベート両用の万能型で、迷ったらまずバイブルをおすすめ。A5は書き込み量重視でA4書類を半分に折って挟めるためビジネスの書類集約に強いが、かさばるのでデスク・自宅常置向き。ミニ6はシャツや上着のポケットに入る常時携帯サイズで、TO DO・打合せメモなどメモ中心の使い方やスマホでスケジュール管理する方に好相性。M5はさらに小さい超携帯メモ用。用途と持ち運び頻度を聞いたうえで、記入量と携帯性のバランスで提案する。',
